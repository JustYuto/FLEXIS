    ...
    <div class="container">
        <div class="form-horizontal">
            <form action="" method="POST">
                ...
                <textarea type="text" name="workReport" placeholder="Write your work report here" rows="4" cols="50"
                    required></textarea>
                <div class="button-group">
                    <input class="btn btn-secondary" type="submit" name="update" value="Update">
                    <input class="btn btn-secondary" type="submit" name="cancel" value="Cancel" formnovalidate>
                </div>
            </form>
        </div>
    </div>
